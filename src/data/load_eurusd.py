...
def load_eurusd(period: str = "10d", interval: str = "5m", symbol: str = "EURUSD=X") -> pd.DataFrame:
    """
    Carga datos de EUR/USD desde Yahoo Finance y devuelve columnas estándar:
    ...
    if missing:
        raise ValueError(
            f"Faltan columnas esperadas en EURUSD: {missing}. "
